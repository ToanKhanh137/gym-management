...
import { Plus, X, Edit3, ToggleLeft, ToggleRight, Users as UsersIcon } from 'lucide-react';
        ...
        <div className="table-wrap">
          ...
          {isLoading ? (
            ...
            <div className="empty-state">
              <div className="empty-state-icon" style={{ fontSize:36, opacity:0.3 }}><UsersIcon size={36} /></div>
